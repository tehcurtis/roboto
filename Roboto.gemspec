...
Gem::Specification.new do |s|
  ...
  s.files = ["History.txt", "Manifest.txt", "PostInstall.txt", "Rakefile", "README.rdoc", "Roboto.gemspec", "VERSION.yml", "lib/roboto", "lib/roboto/robots_txt.rb", "lib/roboto.rb", "spec/roboto_spec.rb", "spec/robots_txt_spec.rb", "spec/spec.opts", "spec/spec_helper.rb"]
  s.has_rdoc = true
